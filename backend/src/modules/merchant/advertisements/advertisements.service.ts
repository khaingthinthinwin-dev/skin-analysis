...
export class AdvertisementsService {
  ...
  private getSchedule(
    ...
    // Earliest selectable start date is today + minDaysFromToday (UTC day
    // granularity). Content upload keeps the 3-day lead time; resubmission
    // (minDaysFromToday = 0) lets the merchant start the ad today.
