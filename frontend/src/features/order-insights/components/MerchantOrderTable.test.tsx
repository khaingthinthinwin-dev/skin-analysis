...
describe('MerchantOrderTable', () => {
  it('renders the customer column and both row actions', () => {
    render(<MerchantOrderTable rows={[{ id: 'order-12345678', createdAt: '2026-09-01', status: OrderStatus.DELIVERED, itemCount: 2, totalAmount: '10.00', paymentStatus: 'completed', customerName: 'Aye Aye' }]} onView={vi.fn()} onSort={vi.fn()} currentSort="createdAt" currentOrder="desc" />);
