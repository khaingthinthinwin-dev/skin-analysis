...
export default function SearchFilter() {
  ...
  const products = [
    { id: 1, name: 'Hydrating Gentle Foam Cleanser', category: 'Cleansers', price: '$24.99', match: '98% Match', rating: 4.9, reviews: 128 },
    { id: 2, name: 'Vitamin C Glowing Serum', category: 'Serums', price: '$42.00', match: '95% Match', rating: 4.8, reviews: 95 },
    { id: 3, name: 'Barrier Repair Cream', category: 'Moisturizers', price: '$36.50', match: '92% Match', rating: 4.9, reviews: 210 },
    { id: 4, name: 'Invisible Shield Sunscreen SPF 50+', category: 'Sunscreen', price: '$28.00', match: '90% Match', rating: 4.7, reviews: 84 },
  ]
